...
<?php include APPROOT . '/views/inc/sidebar.php'; ?>
    ...
    <div class="content-wrapper">
        ...
        <form action="<?php echo URLROOT;?>/admin/edit_class/<?php echo $data['id'];?>" class="form-horizontal" method="post" id="class-add">
            <div class="card-body">
                <div class="form-group row">
                    <label for="name" class="col-sm-3 col-form-label">Class name <span style="color: #f00;">*</span></label>
                    <div class="col-sm-9">
                        <input type="text" class="form-control" id="name" required data-parsley-trigger="keyup" name="name" value="<?php echo $data['class']->name;?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="number" id="class_numeric" name="class_numeric" class="form-control" required data-parsley-trigger="keyup" value="<?php echo $data['class']->class_numeric;?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <select name="teacher_name" id="teacher_name" class="form-control select2" required  data-parsley-trigger="keyup" style="width: 100%;">
                            <option value="<?php echo $data['class']->teacher_name;?>"><?php echo $data['class']->teacher_name;?></option>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="submit" name="add_class" value="Update Class" class="btn btn-info" id="submit">
                    </div>
                </div>
